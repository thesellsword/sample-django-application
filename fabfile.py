"""
Starter fabfile for deploying the test4 project.
...
# CHANGEME
env.hosts = ['user@test4.example.com']
env.code_dir = '/srv/www/test4'
env.project_dir = '/srv/www/test4/test4'
env.static_root = '/srv/www/test4/static/'
env.virtualenv = '/srv/www/test4/.virtualenv'
env.code_repo = 'git@github.com:user/test4.git'
env.django_settings_module = 'test4.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/test4/wsgi.py" % env.code_dir)
